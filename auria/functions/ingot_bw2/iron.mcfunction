#bwvert
execute in minecraft:bedwars2 run summon minecraft:item 305 170 150 {Item:{id:iron_ingot,Count:1}}
#bwrouge
execute in minecraft:bedwars2 run summon minecraft:item 205 170 44 {Item:{id:iron_ingot,Count:1}}
#bwbleu
