#overworld
execute in minecraft:overworld run summon minecraft:item 57 105 -42 {Item:{id:diamond,Count:1}}
#bwGauchevert
...
#bwGauchejaune
execute in minecraft:bedwars run summon minecraft:item 57 73 -42 {Item:{id:diamond,Count:1}}
